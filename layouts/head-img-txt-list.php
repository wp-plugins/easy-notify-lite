...
function head_img_txt_list( $id, $val = '', $type = '' ) {
			...
			$getdata = array( 'headertext', 'maincontent', 'mainimage', 'bullets', 'bulletstyle', 'headertextfont', 'headertextcol', 'maincontentfont', 'maincontentcol', 'bulletsfont', 'bulletssize' );
