...
array( "name" => "Mailing List Manager &nbsp;&nbsp;( <span style='font-style:italic; color:grey;'>PRO Version Only<span> )",
	"type" => "section",
...
array( "type" => "close"),
array( "name" => "Global Styling Options &nbsp;&nbsp;( <span style='font-style:italic; color:grey;'>PRO Version Only<span> )",
	"type" => "section"),
array( "type" => "open"),
